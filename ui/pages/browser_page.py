...
from ui.widgets import SectionCard, make_segment_button
...
class BrowserPage(QWidget):
    def __init__(self, window):
        ...
        self.w.btn_browser_nekro = make_segment_button("Nekro Agent", checkable=True)
        ...
        self.w.btn_browser_napcat = make_segment_button("NapCat", checkable=True)
        ...
        self.w.browser_fill_credentials_btn = make_segment_button("填充凭据")
        ...
        self.w.browser_config_napcat_btn = make_segment_button("一键配网")
        ...
        self.w.browser_open_external_btn = make_segment_button("在系统浏览器打开")
